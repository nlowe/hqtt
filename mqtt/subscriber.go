...
// Handler is a callback configured for an MQTT Subscription. Because a handler may receive a message at any time, they
// do not directly return errors. Implementations should provide a way to deal with errors separately. Handlers must not
// block. Any long-running operations should be run from a new goroutine started by the Handler instead.
